...
//   window.location.href ="./STUDdashboard1.html"
// })
// .catch((error) => {
//   const errorCode = error.code;
//   const errorMessage = error.message;
...
// <script type="module">
  ...
  signupbtn.addEventListener("click", async function () {
    ...
    try {
      ...
      // Store the user's role as 'student' in Firestore
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        if (userData.role === "student") {
          ...
          alert("Successfully signed in as student");
          window.location.href = "./STUDdashboard.html"; // Redirect to student dashboard
        } else {
          alert("Access denied. You are not authorized to log in as a student.");
        }
      } else {
